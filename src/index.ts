...
const args = yargs
    ...
    .option("d", { alias: "date", describe: "The date to filter by. The format should be yyyy-mm-dd. This command is optional.", type: "string" })
    .option("h", { alias: "help", describe: "This command provides help on how to use the app. This command is optional.", type: "string" })
    .argv as Args
